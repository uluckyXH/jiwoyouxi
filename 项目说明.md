...
- 详细进度见 [docs/开发状态.md](docs/开发状态.md)。
...
- 新人先读 [协作开发说明.md](协作开发说明.md)。
- 开发规范按 [docs/鸿蒙原生开发规范.md](docs/鸿蒙原生开发规范.md) 执行。
- 新增游戏按 [docs/新增小游戏接入指南.md](docs/新增小游戏接入指南.md) 接入。
- 游戏认领和候选清单看 [docs/小游戏候选清单.md](docs/小游戏候选清单.md)。
- 真机验收按 [docs/真机验收清单.md](docs/真机验收清单.md) 检查。
- 测试报告留在 [测试报告/](测试报告/)。
- 当前进度和已知风险在 [docs/开发状态.md](docs/开发状态.md)。
...
- 详细拆分规则按 [docs/鸿蒙原生开发规范.md](docs/鸿蒙原生开发规范.md) 执行。
