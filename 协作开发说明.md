...
开发规范、模块拆分、测试和报告留档要求见 [docs/鸿蒙原生开发规范.md](docs/鸿蒙原生开发规范.md)。
...
- 涉及功能、游戏、转场、存储或关键缺陷修复时，在 `测试报告/` 留一份测试报告。

## 新增游戏流程

1. 先在 [docs/小游戏候选清单.md](docs/小游戏候选清单.md) 查候选清单，或用 GitHub issue 模板登记新游戏。
